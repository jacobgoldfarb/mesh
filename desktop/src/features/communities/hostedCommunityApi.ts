...
export function hostedCommunityErrorMessage(
  ...
  const messages: Record<string, string> = {
    ...
    identity_already_bound:
      "This Builderlab account is connected to another Superhuman Mesh identity.",
    pubkey_already_bound:
      "This Superhuman Mesh identity is connected to another Builderlab account.",
    not_owner: "Only the community owner can do that.",
    transferee_not_registered:
      "That person needs a connected Superhuman Mesh identity before you can transfer ownership to them.",
  };
