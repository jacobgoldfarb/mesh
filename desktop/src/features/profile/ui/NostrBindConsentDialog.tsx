...
const COPY_SUCCESS_MESSAGE =
  "Signed response copied. Paste it into the Superhuman Mesh admin console.";
const PREVIEW_COPY_SUCCESS_MESSAGE = "Preview response copied.";
const COPY_FAILURE_MESSAGE = "Superhuman Mesh couldn't access the clipboard. Try again.";
    ...
    const unlistenPromise = listenForNostrBindDeepLinks((nextPayload) => {
      ...
      getIdentity()
        ...
        .catch((error) => {
          ...
          setIdentity(null);
          setError("Could not load the current Superhuman Mesh identity.");
        });
    });
                ...
                >
                  <DialogPrimitive.Title className="mt-6 text-3xl font-semibold tracking-tight">
                    {payload.returnMode === "browser_fragment_v1"
                      ...
                      : "Finish on the Superhuman Mesh website"}
                  ...
                  >
                    {payload.returnMode === "browser_fragment_v1"
                      ? "Superhuman Mesh opened your browser to finish verification."
                      : "Copy the response below, then paste it into the Superhuman Mesh website to finish verification."}
                  </DialogPrimitive.Description>
