...
export function BackupStep({
  ...
  const storageDescription =
    identityStorage === "system-keyring"
      ? "Superhuman Mesh keeps your identity key in your system keychain. Your computer may ask for your password when Superhuman Mesh needs to read the key."
      : identityStorage === "local-file"
        ? "Your system keychain wasn’t available, so Superhuman Mesh keeps your identity key in a private file on this device."
        : "Superhuman Mesh keeps your identity key protected on this device. Make a separate backup in case you lose access.";
  const storageTitle =
    identityStorage === "system-keyring"
  ...
  const introStorageDescription =
    identityStorage === "system-keyring"
      ? "Superhuman Mesh keeps your identity key in your system keychain."
      : identityStorage === "local-file"
        ? "Superhuman Mesh keeps your identity key in a private file on this device because the system keychain wasn’t available."
