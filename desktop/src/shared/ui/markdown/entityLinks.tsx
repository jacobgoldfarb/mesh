...
/**
 * Navigate to the project detail view for a `mesh://pr|issue|repo` link.
...
/**
 * In-app open handlers for `mesh://` entity preview cards, keyed by href.
...
/**
 * Resolve an anchor href to a canonical `mesh://` entity link, accepting
 * both the deep-link scheme directly and HTTPS relay clone URLs (which the
 * preview parser normalizes onto `mesh://repo` only when the URL origin
...
/**
 * Render an inline anchor for a Buzz entity link (`mesh://pr|issue|repo` or
