#!/usr/bin/env bash
# Uninstalls stale worktree-suffixed Mesh debug builds from booted iOS
# simulators and connected Android devices/emulators. Production installs
# (ai.superhuman.mesh.mobile, no suffix) are never touched:
...
ios_prefix="ai.superhuman.mesh.mobile."
android_prefix="ai.superhuman.mesh.mobile."
